...
"""
meetingrooms_volume = {1: 12, 2: 15, 3: 6}  
meetings_time = [[10, 15, 13], [9, 11, 8], [9, 11, 8], [9, 11, 8], [16, 18, 4], [9, 11, 12], [16, 18, 4], [9, 11, 8]]  
...
def make_plan(meetings_time, meetingrooms_volume):
    ...
    for meeting in range(len(meetings_time)):  # ищем место для каждой встречи
        ...
        for room in range(len(meetingrooms_volume)):  # проверяем все открытые переговорки
            ...
            try:
                ...
                print(
                f"Свободные переговорки закончились, для встречи {meeting + 1} ненашлось места\n")
                continue
            ...
            #     print(f"Все переговорки проверены для встречи {meeting + 1} нет места!\n")
            #     continue
...
# meetings_time = [[10, 15, 13], [9, 11, 8], [9, 11, 8], [9, 11, 8], [16, 18, 4], [9, 11, 12], [16, 18, 4], [9, 11, 8], [16, 18, 4], [9, 11, 8], [16, 18, 4]]  
